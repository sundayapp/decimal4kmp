...
<#else>
		...
		@JvmField val ONE = valueOf(1);
		/** The {@code Decimal${scale}f} constant 2.*/
		@JvmField val TWO = valueOf(2);
		/** The {@code Decimal${scale}f} constant 3.*/
		@JvmField val THREE = valueOf(3);
		/** The {@code Decimal${scale}f} constant 4.*/
		@JvmField val FOUR = valueOf(4);
		/** The {@code Decimal${scale}f} constant 5.*/
		@JvmField val FIVE = valueOf(5);
		/** The {@code Decimal${scale}f} constant 6.*/
		@JvmField val SIX = valueOf(6);
		/** The {@code Decimal${scale}f} constant 7.*/
		@JvmField val SEVEN = valueOf(7);
		/** The {@code Decimal${scale}f} constant 8.*/
		@JvmField val EIGHT = valueOf(8);
		/** The {@code Decimal${scale}f} constant 9.*/
		@JvmField val NINE = valueOf(9);
<#if (scale <= 17)>
		/** The {@code Decimal${scale}f} constant 10.*/
		@JvmField val TEN = valueOf(10);
<#if (scale <= 16)>
		/** The {@code Decimal${scale}f} constant 100.*/
		@JvmField val HUNDRED = Decimal${scale}f(100 * ONE_UNSCALED);
<#if (scale <= 15)>
		/** The {@code Decimal${scale}f} constant 1000.*/
		@JvmField val THOUSAND = Decimal${scale}f(1000 * ONE_UNSCALED);
<#if (scale <= 12)>
		/** The {@code Decimal${scale}f} constant 10<sup>6</sup>.*/
		@JvmField val MILLION = Decimal${scale}f(1000000 * ONE_UNSCALED);
<#if (scale <= 9)>
		/** The {@code Decimal${scale}f} constant 10<sup>9</sup>.*/
		@JvmField val BILLION = Decimal${scale}f(1000000000 * ONE_UNSCALED);
<#if (scale <= 6)>
		/** The {@code Decimal${scale}f} constant 10<sup>12</sup>.*/
		@JvmField val TRILLION = Decimal${scale}f(1000000000000L * ONE_UNSCALED);
<#if (scale <= 3)>
		/** The {@code Decimal${scale}f} constant 10<sup>15</sup>.*/
		@JvmField val QUADRILLION = Decimal${scale}f(1000000000000000L * ONE_UNSCALED);
<#if (scale <= 0)>
		/** The {@code Decimal${scale}f} constant 10<sup>18</sup>.*/
		@JvmField val QUINTILLION = Decimal${scale}f(1000000000000000000L * ONE_UNSCALED);
</#if>
</#if>
</#if>
</#if>
		...
		/** The {@code Decimal${scale}f} constant -1.*/
		@JvmField val MINUS_ONE = valueOf(-1);
...
<#if (scale >= 1)>
		...
		@JvmField val TENTH = Decimal${scale}f(ONE_UNSCALED / 10);
<#if (scale >= 2)>
		/** The {@code Decimal${scale}f} constant 0.01.*/
		@JvmField val HUNDREDTH = Decimal${scale}f(ONE_UNSCALED / 100);
<#if (scale >= 3)>
		/** The {@code Decimal${scale}f} constant 0.001.*/
		@JvmField val THOUSANDTH = Decimal${scale}f(ONE_UNSCALED / 1000);
<#if (scale >= 6)>
		/** The {@code Decimal${scale}f} constant 10<sup>-6</sup>.*/
		@JvmField val MILLIONTH = Decimal${scale}f(ONE_UNSCALED / 1000000);
<#if (scale >= 9)>
		/** The {@code Decimal${scale}f} constant 10<sup>-9</sup>.*/
		@JvmField val BILLIONTH = Decimal${scale}f(ONE_UNSCALED / 1000000000);
<#if (scale >= 12)>
		/** The {@code Decimal${scale}f} constant 10<sup>-12</sup>.*/
		@JvmField val TRILLIONTH = Decimal${scale}f(ONE_UNSCALED / 1000000000000L);
<#if (scale >= 15)>
		/** The {@code Decimal${scale}f} constant 10<sup>-15</sup>.*/
		@JvmField val QUADRILLIONTH = Decimal${scale}f(ONE_UNSCALED / 1000000000000000L);
<#if (scale >= 18)>
		/** The {@code Decimal${scale}f} constant 10<sup>-18</sup>.*/
		@JvmField val QUINTILLIONTH = Decimal${scale}f(ONE_UNSCALED / 1000000000000000000L);
</#if>
</#if>
</#if>
</#if>
		...
		*/
		@JvmStatic
		fun valueOf(value: BigInteger): Decimal${scale}f {
		...
		*/
		@JvmStatic
		fun valueOf(value: BigDecimal): Decimal${scale}f {
		...
		*/
		@JvmStatic
		fun valueOf(value: BigDecimal, roundingMode: RoundingMode): Decimal${scale}f {
